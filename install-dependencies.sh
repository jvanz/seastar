...
EOF
    ...
    zypper install -y c-ares-devel cmake hwloc-devel libboost_filesystem1_66_0 \
    libboost_headers1_66_0-devel libboost_program_options1_66_0 libboost_system1_66_0 \
    libboost_test1_66_0 libboost_test1_66_0-devel libboost_thread1_66_0 libcryptopp-devel \
    libgnutls-devel libgnutlsxx28 liblz4-devel libnuma-devel lksctp-tools-devel \
    ninja protobuf-devel ragel xfsprogs-devel yaml-cpp-devel 
else
